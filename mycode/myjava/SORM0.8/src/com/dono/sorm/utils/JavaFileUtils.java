...
import com.dono.sorm.bean.JavaFieldGetSet;
import com.dono.sorm.bean.TableInfo;
import com.dono.sorm.core.DBManager;
import com.dono.sorm.core.MySqlTypeConvertor;
import com.dono.sorm.core.TableContext;
import com.dono.sorm.core.TypeConvertor;
...
public class JavaFileUtils {
	...
	public static JavaFieldGetSet createFieldGetSetSRC(ColumnInfo column,TypeConvertor convertor) {
		...
		jfgs.setFieldInfo("\tprivate "+javaFiledType+" "+column.getName()+";\n");
		
		//public String getUsername(){return username;}
		//生成get方法的源代码
		StringBuilder getSrc = new StringBuilder();
		getSrc.append("\tpublic "+javaFiledType+" get"+StringUtils.firstChar2UpperCase(column.getName())+"(){\n");
		...
		setSrc.append(javaFiledType+" "+column.getName()+"){\n");
...
//		ColumnInfo ci = new ColumnInfo("id","id",0);
